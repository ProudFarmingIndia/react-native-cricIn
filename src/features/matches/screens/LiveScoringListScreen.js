...
export default function LiveScoringScreen() {
  ...
  */
  const battingPool = (() => {
    ...
    const raw =
      battingTeamId && teamAId && String(battingTeamId) === String(teamAId)
        ? match?.teamASquad || []
        : match?.teamBSquad || [];
  ...
  return (
    ...
    >
      ...
      | screen they are on for three hours. canManage is true because
      | reaching the scoring pad already means they run this match - the
      | component still checks with the server before showing controls.
      |
      ...
      */}
      <LiveStreamBanner matchId={matchId} canManage flush />
